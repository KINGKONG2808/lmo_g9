<%@ Page Title="" Language="C#" MasterPageFile="~/view/admin/template-admin.master" AutoEventWireup="true" CodeBehind="utilities-animation.aspx.cs" Inherits="LMO_G9.view.admin.WebForm8" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Utilities-animation Page</title>
</asp:Content>

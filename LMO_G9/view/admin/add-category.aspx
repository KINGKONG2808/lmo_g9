<%@ Page Title="" Language="C#" MasterPageFile="~/view/admin/template-admin.master" AutoEventWireup="true" CodeBehind="add-category.aspx.cs" Inherits="LMO_G9.view.admin.WebForm19" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentRow" runat="server">
    <div class="container">
        ...
        <div class="row padding-2rem">
            <div class="col-lg-4">
                <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btn btn-primary width-100" />
            </div>

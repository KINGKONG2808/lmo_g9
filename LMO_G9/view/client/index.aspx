...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="player">
        <ul>
            <li class="cover">
                <img src="http://i1285.photobucket.com/albums/a583/TheGreatOzz1/Hosted-Images/Noisy-Freeks-Image_zps4kilrxml.png" /></li>
            <li class="info">
                ...
                <div class="button-items">
                    <audio id="music" preload="auto" loop="false">
                        <source src='<%# Bind("source") %>' type="audio/mp3" runat="server" id="source1">
                        <source src='<%# Bind("source") %>' type="audio/ogg" runat="server" id="source2">
                    </audio>
                    <div id="slider">
                        <div id="elapsed"></div>
                    </div>
